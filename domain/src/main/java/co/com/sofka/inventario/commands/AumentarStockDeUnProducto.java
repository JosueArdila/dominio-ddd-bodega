...
public class AumentarStockDeUnProducto extends Command {
    private final InventarioId inventarioId;
    private final PersonaId personaId;
    private final ProductoId productoId;
    private final Stock stock;

    public AumentarStockDeUnProducto(InventarioId inventarioId, PersonaId personaId, ProductoId productoId, Stock stock) {
